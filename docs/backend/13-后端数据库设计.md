...
| `sandbox` | `sandbox.health` | ② 应用层 | ⏳ 无处可挂（03 §7.8） |
...
| `system` | `system.access.unlocked` / `system.access.unlock_failed` / `system.access.locked` / `system.access.locked_attempt` | ② 应用层 | ✅ |
