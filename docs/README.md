...
| 29 | [测试策略与测试 Agent](./shared/29-测试策略与测试Agent.md) | **跨仓测试的唯一落点**：3471 条用例的金字塔实测、⛔「没有一条测试让前端真的调到后端」这个缺口、测试 Agent 的职责与边界、真链路 e2e 方案、变异验证制度化。25/12 各管一个仓，缺口在两仓之间时看这里 |
...
<!-- branch-protection probe 1788750392 -->
